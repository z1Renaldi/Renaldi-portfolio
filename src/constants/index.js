...
export const certificates = [
  {
    id: 1,
    title: 'ISO 27001 Foundation — Information Security',
    issuer: 'Taalenta Digital Inteleksia',
    date: '2024',
    img: '/certs/BCAAPI.png', // <-- path dari /public
    credentialUrl: '#',
  },
  {
    id: 2,
    title: 'SAP S/4HANA Configuration',
    issuer: 'SAP University Alliance • ITHB',
    date: '2022',
    img: '/certs/sap-s4hana.png',
    credentialUrl: '#',
  },
  {
    id: 3,
